...
public class EffectualButtonBlue : Control
{
    #region " MouseStates "
...
public class EffectualTheme : ContainerControl
{
    public EffectualTheme()
    {
        SetStyle(ControlStyles.UserPaint | ControlStyles.SupportsTransparentBackColor, true);
...
public class EffectualGroupBox : ContainerControl
{

    public EffectualGroupBox()
    {
        SetStyle(ControlStyles.UserPaint | ControlStyles.SupportsTransparentBackColor, true);
        BackColor = Color.Transparent;
        DoubleBuffered = true;
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        ImageToCodeClass ICT = new ImageToCodeClass();
...
public class EffectualProgressBarBlue : Control
{
    ...
    public EffectualProgressBarBlue()
        : base()
    {
        DoubleBuffered = true;
        SetStyle(ControlStyles.UserPaint | ControlStyles.SupportsTransparentBackColor, true);
...
public class EffectualProgressBarOrange : Control
{
    ...
    public EffectualProgressBarOrange()
        : base()
    {
        DoubleBuffered = true;
        SetStyle(ControlStyles.UserPaint | ControlStyles.SupportsTransparentBackColor, true);
...
public class EffectualCheckBox : Control
{
